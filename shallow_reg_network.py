...
class ShallowRegNetwork(object):
    def __init__(self, inp_shape=12, out_shape=2, num_branches=68, num_filters=12):
    ...
    def create_branch(self, branch_prefix):
        """inp_shape """
        _depth_multiplier = 2
        input_1 = Input(shape=(self.inp_shape, self.inp_shape, 3))

        b1_cnv2d = DepthwiseConv2D(depth_multiplier=self.num_filters, kernel_size=(3, 3), strides=(2, 2), padding='same',
        ...
        b3_cnv2d = DepthwiseConv2D(depth_multiplier=_depth_multiplier, kernel_size=(3, 3), strides=(2, 2), padding='same',
        ...
        b5_cnv2d = DepthwiseConv2D(depth_multiplier=_depth_multiplier, kernel_size=(3, 3), strides=(2, 2), padding='same',
        ...
        b7_cnv2d = DepthwiseConv2D(depth_multiplier=_depth_multiplier, kernel_size=(3, 3), strides=(2, 2), padding='same',
        ...
        '''b8'''
        b8_dw2d = DepthwiseConv2D(kernel_size=3, strides=1, activation=None, use_bias=False,
